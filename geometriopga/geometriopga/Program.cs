    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (Shape shape in shapes)
            {
                ...
                if (shape.Shape_Type == EShapeType.square)
                {
                    ...
                    switch (temp_square)
                    {
                        ...
                        case ESquareType.square:
                            ...
                            Console.WriteLine($"This squares area is = {square_cast.Area()}");
                        ...
                        case ESquareType.rectangle:
                            ...
                            Console.WriteLine($"This rectangles area is = {Rectangle_cast.Area()}");
                        ...
                        case ESquareType.parallelogram:
                            ...
                            Console.WriteLine($"This parallelogram area is = {parallelogram_cast.Area()}");
                        ...
                        case ESquareType.trapez:
                            ...
                            Console.WriteLine($"This trapez area is = {trapez_cast.Area()}");
                ...
                else if (shape.Shape_Type == EShapeType.triangle)
                {
                    ...
                    switch (triangle_cast.TriangleType)
                    {
                        ...
                        case ETriangleType.Right:
                            ...
                            Console.WriteLine($"This right angled area is = {triangle_cast.Area()}");
