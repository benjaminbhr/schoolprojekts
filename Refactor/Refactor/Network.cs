    ...
    public class Network
    {
        public string DisplayDhcpServerAddresses()
        {
            ...
            foreach (NetworkInterface adapter in adapters)
            {
                ...
                if (addresses.Count > 0)
                {
                    ...
                    {
                        addressString += $"  Dhcp Address ............................ : {address} \n";
                    }
                }
            }
        ...
        public string[] LocalPing()
        {
            ...
            if (reply.Status == IPStatus.Success)
            {
                ...
                stringArray[1] = "RoundTrip time:: " + reply.RoundtripTime;
                stringArray[2] = "Time to live: " + reply.Options.Ttl;
                stringArray[3] = "Don't fragment: " + reply.Options.DontFragment;
                stringArray[4] = "Buffer size: " + reply.Buffer.Length;
            }
            else
            {
